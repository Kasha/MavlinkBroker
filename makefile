deploy_app = cp MavlinkBroker /media/liadky-yoga-dev/d50ef647-507d-40ee-8a76-78e075e99e8c/liad/dev/

VPATH = src 

all: git_submodule MavlinkBroker


MavlinkBroker: mavlink_control.cpp src/serial_port.cpp src/udp_port.cpp src/colugo_broker.cpp src/CC/ECC.cpp autopilot_interface.cpp
